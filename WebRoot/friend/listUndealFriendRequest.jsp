   		...
   		<tr>
   			...
   			<td>
   				<form action="friendRequest_dealFriendRequest" method="post">
   					...
   					<input type="radio" name="resultStr" value="agreeAndRequest"/>agreeAndRequest
   					<input type="radio" name="resultStr" value="agree"/>agree
   					<input type="radio" name="resultStr" value="deny"/>deny
