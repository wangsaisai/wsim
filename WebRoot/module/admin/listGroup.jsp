...
<script>
	function getHref(){
		...
		document.getElementById("tiaozhuan").href = 'admin/manager_listGroup.action?currentPage='+pageNum + '${msg}';
	}
</script>
		        ...
		        <table width="100%" border="0" cellspacing="0" cellpadding="0">
		          <tr>
		            <td>
			            <table width="100%" border="0" cellspacing="0" cellpadding="0">
			              <tr>
			                <td width="100%" valign="bottom"><span class="STYLE1">群组管理</span></td>
			              </tr>
			            </table>
		            </td>
		            <td></td>
    ...
    <td>
	    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
	      <tr>
	        ...
	        <td width="30%" height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">群名称</span></div></td>
	        <td width="20%" height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">群号</span></div></td>
	      ...
	      <tr>
	        ...
	        <td height="25" bgcolor="#FFFFFF" class="STYLE19"><div align="center">${number }</div></td>
	        <td height="25" bgcolor="#FFFFFF" class="STYLE19">
	        	<div align="center">
	        		<s:a href="admin/manager_delGroup?groupId=%{id}" onclick="return confirm('确定删除吗？')">删除</s:a>
	        	</div>
	        </td>
	      </tr>
	      </s:iterator>
    ...
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td width="49"><div align="center"><a href="admin/manager_listGroup.action?currentPage=1${msg}"><img src="common/img/main_54.gif" width="40" height="15"/></a></div></td>
            <s:if test="page.hasPrePage">
            	<td width="49"><div align="center"><a href="admin/manager_listGroup.action?currentPage=${page.currentPage - 1 }${msg}"><img src="common/img/main_56.gif" width="45" height="15" /></a></div></td>
            </s:if>
            <s:else>
            	<td width="49"><div align="center"><img src="common/img/main_56.gif" width="45" height="15" /></div></td>
            </s:else>
            <s:if test="page.hasNextPage">
            	<td width="49"><div align="center"><a href="admin/manager_listGroup.action?currentPage=${page.currentPage + 1 }${msg}"><img src="common/img/main_58.gif" width="45" height="15"/></a></div></td>
            </s:if>
            <s:else>
            	<td width="49"><div align="center"><img src="common/img/main_58.gif" width="45" height="15" /></div></td>
            </s:else>
            <td width="49"><div align="center"><a href="admin/manager_listGroup.action?currentPage=${page.totalPage }${msg}"><img src="common/img/main_60.gif" width="40" height="15" /></a></div></td>
