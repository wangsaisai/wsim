          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="100%" valign="bottom"><span class="STYLE1">管理人员基本信息列表</span></td>
              </tr>
            </table></td>
            <td></td>
          </tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="20%" height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">用户名</span></div></td>
        <td width="20%" height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">email</span></div></td>
        <td width="30%" height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">是否管理员</span></div></td>
      	<td width="15%" height="30" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">删除</span></div></td>
      </tr>
      ...
      <tr>
        ...
        <td height="25" bgcolor="#FFFFFF" class="STYLE19"><div align="center" class="STYLE21"><s:if test="isAdmin==true">是</s:if><s:else>否</s:else></div></td>
        <td height="25" bgcolor="#FFFFFF" class="STYLE19"><div align="center" class="STYLE21"><s:if test="isAdmin==false"><s:a href="admin_delUser?userId=%{id}&currentPage=%{page.currentPage}" onclick="return confirm('确定删除吗？')">删除</s:a></s:if></div></td>
      </tr>
      </s:iterator>
    </table></td>
  </tr>
