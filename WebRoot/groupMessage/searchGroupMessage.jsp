...
<html>
  ...
  <body>
    <form action="groupMessage_searchGroupMessageByTime" name="searchGroupMessage" id="searchGroupMessage" method="post">
    	<input type="text" name="groupId" id="groupId" placeholder="groupId" required="true"/>
