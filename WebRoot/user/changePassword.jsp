...
<html>
  ...
  <body>
    <form action="user_changePassword" name="changePassword" id="changePassword" method="post">
    	<table>
  			<tr>
  				<th colspan="2">修改 密码</th>
  			</tr>
  			<tr>
  				<td><input type="text" id="oldPassword" name="oldPassword" placeholder="oldPassword" required="true"/></td>
  			...
  			<tr>
  				<td><input type="password" id="confpassword" name="confpassword" placeholder="confpassword" required="true"/></td>
